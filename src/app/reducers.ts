...
import { RESET_CATS, SET_CATEGORIES, SET_CATS, SET_PAGE, SET_SELECTED_CATEGORY } from './constants';
...
export function selectedCategoryReducer(state: number | null = null, action: any) {
  switch(action.type) {  
